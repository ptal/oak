...
Compiled on the nightly channel of Rust. Use [rustup](http://www.rustup.rs) for managing compiler channels. You can download the exact same version of the compiler used with `rustup override add nightly-2016-07-06`.
